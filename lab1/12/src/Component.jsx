...
export default class Component extends React.Component {
  ...
  handleLogButton = (deleteId) => {
    this.setState((prevState) => {
      ...
      return {
        logList: newLogList,
        currentValue: newLogList.length === 0 ? 0 : prevState.currentValue, // сбрасываем, если список пуст
      };
    });
  };
  ...
  render() {
    ...
    return (
      <div>
        ...
        {logList.length > 0 && ( // Рендерим лог, только если есть записи
